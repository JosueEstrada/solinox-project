  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="grid gap-8 text-center lg:grid-cols-1 sm:grid-cols-2 col-span-1">
        <div>
          <div className="flex mx-auto items-center justify-center w-16 h-16 rounded-lg bg-gray-800/[0.1] text-[rgb(75,85,99)]">
            <svg
              className="w-8 h-8"
              fill="currentColor"
              viewBox="0 0 20 20"
        ...
        <div>
          ...
          <p className="">
            SILVER LAKE, United States 1941 Late Avenue <br /> Zip Code/Postal
            code:03875
          </p>
        </div>
        <div>
